...
/** Default floor colors for each room zone — dark blue-grey theme */
const COLOR_CONFERENCE: FloorColor = { h: 220, s: 12, b: -25, c: 0 }   // dark blue-grey
const COLOR_MAIN: FloorColor = { h: 220, s: 8, b: -25, c: 0 }          // dark blue-grey
const COLOR_BREAK: FloorColor = { h: 220, s: 6, b: -20, c: 0 }         // dark blue-grey
const COLOR_DOORWAY: FloorColor = { h: 220, s: 10, b: -22, c: 0 }      // dark blue-grey
const COLOR_ENTRY: FloorColor = { h: 220, s: 8, b: -18, c: 0 }         // dark blue-grey
const COLOR_OFFICE: FloorColor = { h: 220, s: 10, b: -28, c: 0 }       // dark blue-grey
