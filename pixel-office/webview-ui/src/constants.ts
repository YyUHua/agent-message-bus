...
export const FALLBACK_FLOOR_COLOR = '#2a2d3a'
...
export const DEFAULT_FLOOR_COLOR: FloorColor = { h: 220, s: 8, b: -25, c: 0 }
export const DEFAULT_WALL_COLOR: FloorColor = { h: 220, s: 12, b: -8, c: 0 }
